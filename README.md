...
$$
\begin{pmatrix} (6 \times 7 + 24 \times 4) \mod 26 \\ (1 \times 7 + 13 \times 4) \mod 26 \end{pmatrix} = \begin{pmatrix} 138 \mod 26 \\ 59 \mod 26 \end{pmatrix} = \begin{pmatrix} 8 \\ 7 \end{pmatrix}
$$

El bloque cifrado es entonces:
